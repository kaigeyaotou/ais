...
namespace AIS.MGT.Api.Commands
{
    ...
    {
        public class UnitLobCoverageDivisionTreeQueryCommand : IRequest<IEnumerable<UnitTreeOut>>
        {

        }

        public class Handler : IRequestHandler<UnitLobCoverageDivisionTreeQueryCommand, IEnumerable<UnitTreeOut>>
        {
