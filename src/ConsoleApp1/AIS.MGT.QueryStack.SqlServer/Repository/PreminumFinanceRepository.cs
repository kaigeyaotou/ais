...
WHERE
	deleted =0");
        ...
        public async Task<(IEnumerable<dynamic> data, int page)> GetAgencyPage(string condition, int pageSize, int pageIndex)
        {
...
");
            ...
            var result = await dbConnection.QueryMultipleAsync(sqltotal);
