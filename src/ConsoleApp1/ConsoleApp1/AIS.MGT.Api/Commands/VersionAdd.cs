...
namespace AIS.MGT.Api.Commands
{
    ...
    {
        public class VersionAddCommand : IRequest<WebApiResult>
        {
            public VersionArg versionArg { get; set; }
        }

        public class Handler : IRequestHandler<VersionAddCommand, WebApiResult>
        {
            ...
            public async Task<WebApiResult> Handle(VersionAddCommand request, CancellationToken cancellationToken)
            {
                try
                {
                    // get max ord
                ...
                catch (Exception ex)
                {
                    ...
                    return WebApiResult.Error(ex.Message);
                }
