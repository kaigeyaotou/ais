...
namespace AIS.MGT.Api.Commands
{
    ...
    {
        public class ContractTreeQueryCommand : IRequest<WebApiResult<IEnumerable<ContractTree>>>
        {
            public int id_version { get; set; }
        }

        public class Handler : IRequestHandler<ContractTreeQueryCommand, WebApiResult<IEnumerable<ContractTree>>>
        {
