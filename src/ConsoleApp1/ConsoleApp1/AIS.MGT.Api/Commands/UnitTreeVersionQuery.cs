...
namespace AIS.MGT.Api.Commands
{
    ...
    {
        public class UnitTreeVersionQueryCommand : IRequest<WebApiResult<IEnumerable<UnitTreeOut>>>
        {
            public int id_version { get; set; }
        }

        public class Handler : IRequestHandler<UnitTreeVersionQueryCommand, WebApiResult<IEnumerable<UnitTreeOut>>>
        {
            ...
            public async Task<WebApiResult<IEnumerable<UnitTreeOut>>> Handle(UnitTreeVersionQueryCommand request, CancellationToken cancellationToken)
            {
